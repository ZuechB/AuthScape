...
export default function PhotoEditor({isOpen, photoUrls = [], onCancelEditor = null, onPhotoUpdated = null}) {
        ...
        <Dialog
            ...
            <DialogContent>
              {/* <DialogContentText id="alert-dialog-description"> */}
                ...
                {(selectedImageUrl == null) &&
                  <Box>
                   <Dropzone text="Drag 'n' drop your photo or click to select photo" multiple={false} onDrop={(file) => {
