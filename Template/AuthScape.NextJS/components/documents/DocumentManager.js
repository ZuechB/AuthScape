    ...
    return (
      ...
      <Box sx={{height: "85vh", width: '100%' }}>
        ...
        <Menu
          ...
          }}><ShareRoundedIcon sx={{paddingRight:1}} /> Share</MenuItem>
          <Divider />
          ...
          }}><DeleteRoundedIcon sx={{paddingRight:1}}/> Delete</MenuItem>
        </Menu>
      </Box>
      ...
      <Dialog
        ...
        <DialogTitle id="alert-dialog-title">
          Are you sure you want to delete {contextFile != null ? contextFile.name : ""}?
        </DialogTitle>
        <DialogContent>
      ...
      <Dialog
        ...
        aria-describedby="alert-dialog-description">
        <DialogTitle id="alert-dialog-title">
          Share {contextFile != null ? contextFile.name : ""}
        </DialogTitle>
        <DialogContent>
          ...
          <List dense sx={{ width: '100%', maxWidth: 360, bgcolor: 'background.paper' }}>
            {[0, 1, 2, 3].map((value) => {
              ...
              return (
                <SharedListItem value={value} labelId={labelId} />
              );
            })}
          </List>
