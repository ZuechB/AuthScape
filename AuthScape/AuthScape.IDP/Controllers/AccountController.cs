...
namespace IDP.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public IActionResult Register(string returnUrl = null)
        {
            ...
            ViewData["returnUrl"] = redirectUri;
            return View();
        }
        ...
        public async Task<IActionResult> Register(RegisterViewModel model, string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                var timezone = TimeZoneExtention.ConvertIanaIdToWindowsTime(model.TimeZone);
                ...
                try
                {
                    ...
                    if (result.Succeeded)
                    {
                        ...
                        _applicationDbContext.Companies.Add(newCompany);
                        await _applicationDbContext.SaveChangesAsync();




                        var userSignedUp = await _applicationDbContext.Users.Where(u => u.Id == user.Id).FirstOrDefaultAsync();
        ...
        public async Task<IActionResult> ExternalLoginCallback(string returnUrl = null)
        {
            ...
            else
            {
                ...
                //var items = info.AuthenticationProperties.Items;
                ...
                var fbId = info.Principal.FindFirstValue(ClaimTypes.NameIdentifier);
        ...
        public async Task<IActionResult> GetCompanies(string search)
        {
            if (!String.IsNullOrWhiteSpace(search))
            {
                ...
                var companyQuery = await _applicationDbContext.Companies
                    .Where(c => c.Title.ToLower().Contains(search))
                    .Select(c => new Select2Result()
                    {
                        id = c.Id,
                        text = c.Title
                    })
                ...
                return Json(new Select2Results()
                {
