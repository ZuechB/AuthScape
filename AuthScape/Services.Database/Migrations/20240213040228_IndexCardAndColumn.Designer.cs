...
namespace Services.Database.Migrations
{
    ...
    [Migration("20240213040228_IndexCardAndColumn")]
    partial class IndexCardAndColumn
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AuthScape.Document.Mapping.Models.Product", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("AuthScape.Document.Mapping.Models.ProductAttribute", b =>
                {
            ...
            modelBuilder.Entity("AuthScape.Kanban.Models.KanbanAssignedTo", b =>
                {
                    b.Property<long>("UserId")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("AuthScape.Kanban.Models.KanbanCard", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("AuthScape.Kanban.Models.KanbanColumn", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("AuthScape.Document.Mapping.Models.ProductAttribute", b =>
                {
                    ...
                    b.HasOne("AuthScape.Document.Mapping.Models.Product", "Product")
                        .WithMany("ProductAttributes")
            ...
            modelBuilder.Entity("AuthScape.Kanban.Models.KanbanAssignedTo", b =>
                {
                    b.HasOne("AuthScape.Kanban.Models.KanbanCard", "KanbanCard")
            ...
            modelBuilder.Entity("AuthScape.Kanban.Models.KanbanCard", b =>
                {
                    b.HasOne("AuthScape.Kanban.Models.KanbanColumn", "KanbanColumn")
                        .WithMany("Cards")
