...
namespace Services.Database.Migrations
{
    ...
    [Migration("20240120230712_DocumentMappingFieldsAdded")]
    partial class DocumentMappingFieldsAdded
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AuthScape.Document.Mapping.Models.DocumentAttributeHeader", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("DocumentAttributeHeader");
                });

            modelBuilder.Entity("AuthScape.Document.Mapping.Models.DocumentAttributeValue", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid>("DocumentAttributeHeaderId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("DocumentAttributeHeaderId");

                    b.ToTable("DocumentAttributeValue");
                });
            ...
            modelBuilder.Entity("AuthScape.Document.Mapping.Models.DocumentAttributeValue", b =>
                {
                    b.HasOne("AuthScape.Document.Mapping.Models.DocumentAttributeHeader", "DocumentAttributeId")
                        .WithMany("DocumentAttributeValues")
                        .HasForeignKey("DocumentAttributeHeaderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("DocumentAttributeId");
                });
            ...
            modelBuilder.Entity("AuthScape.Document.Mapping.Models.DocumentAttributeHeader", b =>
                {
                    b.Navigation("DocumentAttributeValues");
                });
